...
import { X, Calendar, Clock, User as UserIcon, Search, ChevronDown, Plus, AlertTriangle, Check, ArrowRight, ArrowLeft, CreditCard, Sparkles, MapPin, Briefcase } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-lumina-base border-b border-lumina-highlight p-6 flex flex-col md:flex-row justify-between items-center gap-4 shrink-0">
            <div>
                <h2 className="text-xl font-display font-bold text-white">New Booking</h2>
                <p className="text-xs text-lumina-muted">Wizard Mode</p>
            </div>
